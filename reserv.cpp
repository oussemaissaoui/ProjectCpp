    ...
    ui(new Ui::Reserv)
{
   ...
   //date de debut
    ...
    connect(ui->numres_3,&QLineEdit::textChanged,this,&Reserv::SetLineEdit_value);
}
...
void Reserv::on_ajouter_clicked()
{
...
void Reserv::on_pushButton_6_clicked()
{
...
void Reserv::on_ajouter_4_clicked()
{
...
void Reserv::on_recherche_clicked()
{
...
void Reserv::on_pushButton_3_clicked()
{
    Reservation* r = new Reservation();
...
void Reserv::on_GENERER_PDF_2_clicked()
{
...
void Reserv::on_pushButton_2_clicked()
{
...
void Reserv::on_pushButton_check_clicked()
{
    QByteArray data;
