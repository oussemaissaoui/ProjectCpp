...
QT_MOC_LITERAL(1, 11, 14), // "signalReceived"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 13) // "checkDatabase"

    },
    "Connection\0signalReceived\0\0checkDatabase"
};
...
void Connection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalReceived(); break;
        case 1: _t->checkDatabase(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Connection::signalReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Connection::signalReceived()
{
