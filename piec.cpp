    ...
    ui(new Ui::piec)
{
    ...
    ui->lineEdit_nb_pieces_2->setValidator(new QIntValidator(0,9999,this));
        ...
        ui->TableViewPieceRecherche->setModel(P.afficher());
...
void piec::on_pushButton_Valider_2_clicked()
{
...
void piec::on_pushButton_Supprimer_clicked()
{
    Piece P1;
    P1.setreference(ui->lineEdit_Modification->text());
    bool test=P1.supprimer(P1.get_reference());
    QMessageBox msgBox;
    if (test)
    {
        msgBox.setText("Suppression avec succes");
        ui->TableViewPieceRecherche->setModel(P1.afficher());
...
void piec::on_pushButton_Modifier_clicked()
{
...
void piec::on_pushButton_Chercher_3_clicked()
{
...
void piec::on_pushButton_Trier_clicked()
{
    Piece *p= new Piece();
    ui->TableViewPieceRecherche->setModel(p->trierPiece());
}
void piec::on_pushButton_statistiques_clicked()
{
...
void piec::on_pushButton_PDF_clicked()
{
...
void   piec::mailSent(QString status)
{
...
void piec::on_sendBtn_clicked()
{
    sendMail();
}

void piec::on_pushButton_quantite_clicked()
{
    Piece p;
    QSqlQueryModel* model=new QSqlQueryModel();
        int total_pieces = model->rowCount();
